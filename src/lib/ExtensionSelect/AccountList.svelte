...
{#each accounts as account}
  <div
    ...
    class="flex flex-row justify-center items-center gap-2 w-64 h-16 bg-white dark:bg-base-100 rounded-lg cursor-pointer"
  >
    <img src={TalismanIcon} alt="talisman account" />
